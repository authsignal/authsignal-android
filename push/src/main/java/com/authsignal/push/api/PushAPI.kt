...
class PushAPI(tenantID: String, private val baseURL: String) {
  ...
  suspend fun getCredential(publicKey: String): AuthsignalResponse<PushCredential> {
    ...
    val url = "$baseURL/v1/client/user-authenticators/push?publicKey=$encodedKey"
  ...
  suspend fun addCredential(
    ...
    val url = "$baseURL/v1/client/user-authenticators/push"
  ...
  suspend fun removeCredential(
    ...
    val url = "$baseURL/v1/client/user-authenticators/push/remove"
  ...
  suspend fun getChallenge(publicKey: String): AuthsignalResponse<String> {
    val encodedKey = Encoder.toBase64String(publicKey.toByteArray())
    val url = "$baseURL/v1/client/user-authenticators/push/challenge?publicKey=$encodedKey"
  ...
  suspend fun updateChallenge(
    ...
    val url = "$baseURL/v1/client/user-authenticators/push/challenge"
